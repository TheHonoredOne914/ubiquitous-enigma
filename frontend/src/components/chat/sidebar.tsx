      ...
      <div
        ...
        className={cn(
          ...
          isActive
            ...
            : "border-sidebar-border/50 bg-sidebar/70 text-sidebar-foreground hover:border-[#3b6fd430] hover:bg-sidebar-accent/70",
        )}
        style={{
        ...
        <div className="flex min-w-0 flex-1 items-center gap-3 pl-1">
          <div
            className={cn(
              ...
              isActive
                ? "border-[#3b6fd430] bg-[#3b6fd414] text-[#6f93e8]"
                : "border-sidebar-border/60 bg-background/60 text-muted-foreground",
            )}
          >
  ...
  return (
    <motion.button
      ...
      className={cn(
        ...
        isActive
          ? "border-[#3b6fd430] bg-[#1a1c22] text-[#eeeef5] shadow-sm"
          : "border-transparent bg-transparent text-[#9a9ab0] hover:text-[#c0c0d0]",
      )}
        ...
        <div
            className={cn(
              ...
              isActive
                ...
                : "border-[#2a2d38] bg-[#111215] text-[#6b6b82]",
            )}
          >
          <ArchiveIcon className="h-4 w-4" />
        </div>
        <div className="min-w-0 flex-1">
          <div className="truncate text-sm font-medium text-[#eeeef5]">{archive.name}</div>
          <div className="mt-1 line-clamp-2 text-[11px] leading-4 text-[#6b6b82]">
...
function SharedSidebarContent({
  ...
  return (
    <div className="flex h-full min-h-0 flex-col bg-[#0d0e12]">
      ...
      <div
        className={cn(
          "shrink-0 border-b border-[#1e2028]",
      ...
      >
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            ...
            <h2 className="mt-1 text-base font-semibold text-[#eeeef5]">Dossier navigation</h2>
            <p className="mt-1 text-xs text-[#6b6b82]">
        ...
        <div className="mt-4 space-y-2">
          <div className="flex items-center justify-between">
            <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-[#6b6b82]">Dossiers</p>
            {activeArchive && <span className="text-[11px] text-[#6b6b82]">Active brief</span>}
          </div>
        ...
        <div className="relative mt-4">
          ...
          <Input
            ...
            className="h-10 rounded-xl border-[#2a2d38] bg-[#111215] pl-9 text-xs text-[#eeeef5] placeholder:text-[#6b6b82] focus-visible:ring-[#3b6fd4]"
      ...
      <ScrollArea className="flex-1">
        <div className={cn("space-y-3", isMobile ? "p-4" : "px-5 py-4")}>
          <div className="flex items-center justify-between">
            <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-[#6b6b82]">Conversations</p>
      ...
      <div
        className={cn(
          "shrink-0 border-t border-[#1e2028]",
          isMobile ? "p-4" : "px-5 py-4",
        )}
      >
        <div className="rounded-xl border border-[#1e2028] bg-[#111215] p-3">
          <ModelLimitsPanel />
        </div>
...
function DesktopSidebar({
  ...
  return (
    <motion.aside
      initial={false}
      className="relative z-30 hidden h-full shrink-0 border-r border-[#1e2028] bg-[#0d0e12] shadow-sm md:flex"
    >
      <div className="flex w-16 shrink-0 flex-col items-center justify-between border-r border-[#1e2028] px-2 py-3">
        <div className="flex w-full flex-col items-center gap-3">
          ...
          <div className="pt-1 text-[9px] font-semibold uppercase tracking-[0.16em] text-[#4f5266]">Desk</div>

          <RailTooltip label={desktopExpanded ? "Collapse navigation panel" : "Expand navigation panel"}>
            <Button
              variant="ghost"
              size="icon"
              className="h-9 w-9 rounded-xl border border-[#2a2d38] bg-[#111215] text-[#9a9ab0] hover:border-[#3b6fd450] hover:bg-[#1a1c22] hover:text-[#eeeef5]"
          ...
          <RailTooltip label="New archive">
            <Button
              variant="outline"
              size="icon"
              className="h-9 w-9 rounded-xl border-[#2a2d38] bg-[#111215] text-[#9a9ab0] hover:border-[#d4a03b50] hover:bg-[#1a1c22] hover:text-[#d4a03b]"
        ...
        <div className="flex w-full flex-col items-center gap-3 border-t border-[#1e2028] pt-3">
          <div className="text-[9px] font-semibold uppercase tracking-[0.16em] text-[#4f5266]">System</div>
          ...
          <RailTooltip label={isDark ? "Switch to light mode" : "Switch to dark mode"}>
            <Button
              variant="ghost"
              size="icon"
              className="h-9 w-9 rounded-xl border border-[#2a2d38] bg-[#111215] text-[#9a9ab0] hover:border-[#d4a03b50] hover:bg-[#1a1c22] hover:text-[#d4a03b]"
              onClick={toggle}
      ...
      <motion.div
        ...
        className={cn(
          "absolute left-full top-0 h-full overflow-hidden border-r border-[#1e2028] bg-[#0d0e12] shadow-[24px_0_80px_rgba(0,0,0,0.32),0_-1px_0_rgba(59,111,212,0.18)]",
