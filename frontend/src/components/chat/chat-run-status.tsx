        ...
        <section className="welcome-intel-section">
          <div className="flex items-start justify-between gap-3">
            ...
            <span className={cn(
              ...
              summary.statusSeverity === "success" && "border-emerald-500/30 bg-emerald-500/10 text-emerald-300",
              summary.statusSeverity === "warning" && "border-amber-500/30 bg-amber-500/10 text-amber-300",
              summary.statusSeverity === "error" && "border-red-500/30 bg-red-500/10 text-red-300",
              summary.statusSeverity === "info" && "border-slate-500/25 bg-slate-500/10 text-slate-200",
            )}>
          ...
          <div className="mt-3 rounded-lg border border-border/30 bg-muted/30 p-3">
            ...
            {summary.gapText && (
              ...
              <details className="mt-2">
                <summary className="cursor-pointer text-[10px] font-semibold text-amber-400">Show gap details</summary>
                <p className="mt-1 text-[10px] leading-4 text-amber-200/80">{summary.gapText}</p>
              </details>
            )}
          </div>
        </section>
